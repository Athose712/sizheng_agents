...
"""
JindaishiAnswerAgent
=====================

基于“近现代史纲要”的检索增强问答 Agent，结构与马原项目相同。
"""
...
class JindaishiAnswerAgent(BaseRetrievalAgent):
    """近现代史纲要的检索增强问答 Agent。"""

    def __init__(
        self,
        *,
        subject_name: str = "中国近现代史纲要",
        vectorstore_path: str = "database_agent_jindaishi",
